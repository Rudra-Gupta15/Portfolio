...
const TIMELINE = [
  ...
  type: 'work',
  accent: '#d4a843',
  desc: 'Building and developing real-world software solutions with a focus on AI/ML, LLMs, and scalable intelligent systems.',
  bullets: [
    'Developing production-ready AI/ML and software solutions.',
    'Building and integrating LLM-powered applications and intelligent systems.',
    'Designing scalable ML pipelines and optimizing model performance.',
    'Translating AI/ML concepts into practical software solutions for real-world use cases.',
  ],
  chips: ['AI/ML', 'LLM', 'Software Development', 'Python', 'Deep Learning', 'Problem Solving'],
  },
  {
    date: 'Current',
    ...
    bullets: [
      'BalanceTab: Productivity and gaming balance dashboard (v2.8).',
      'TimeMark: Instant video timestamp bookmarking tool (v1.4).',
      'End-to-end ownership: UI design to store publishing.',
    ...
    type: 'work',
    accent: '#d4a843',
    desc: 'Engineering real-world AI/ML solutions, focusing on LLMs and deep learning to solve complex problems.',
    bullets: [
      'Architecting & deploying production-grade LLM and DL solutions.',
      'Developed new learning concepts & optimized model architectures.',
      'Bridging research & scalable ML systems for business impact.',
      'End-to-end AI pipelines with advanced Python workflows.',
    ],
    chips: ['LLM', 'ML', 'DL', 'Python', 'Real-World AI', 'Problem Solving'],
  },
  {
    date: '2025 — 2026',
    role: 'Game Developer',
  ...
  },
  {
    ...
    type: 'edu',
    accent: '#4da8e8',
    desc: 'Focusing on VLSI Design and Embedded Systems. Current CGPA: 8.64.',
    bullets: [
      'Developed a Multi-scale ASL recognition system using YOLOv8 & CNN.',
      'Specialized in VLSI Design, Embedded Systems, and Digital Electronics.',
      'Led sponsorship and operations as Vice President for ICON Technical Fest.',
      'Integrating AI/ML solutions with hardware for real-world applications.',
    ],
